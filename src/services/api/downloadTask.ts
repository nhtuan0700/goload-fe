...
import { GoLoadCreateDownloadTaskRequest, GoLoadDeleteDownloadTaskRequest, GoLoadGetDownloadTaskListRequest } from '@/services/dataaccess'
...
export const deleteDownloadTask = (request: GoLoadDeleteDownloadTaskRequest) => {
  const client = buildClient()
